...
class PythonService {
  ...
  PythonService({this.scriptPath = 'python_backend/endoscope_ai.py'});

  Future<String> transcribe(
    String audioPath, {
    String modelPath = 'python_backend/models/vosk',
  }) async {
  ...
  Future<List<dynamic>> detectImage(
    String imagePath, {
    String weightsPath = 'python_backend/models/endoscope.pt',
  }) async {
    final result = await Process.run('python', [
      scriptPath,
      'detect',
  ...
  Stream<String> listen({
    ...
    _listenProcess = await Process.start('python', [
      scriptPath,
      'listen',
      modelPath,
    ], runInShell: true);
