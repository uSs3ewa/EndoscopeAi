            ...
            children: [
              ...
              Form(
                ...
                child: Column(
                  spacing: 10,
                children: [
                  CustomTextFormField(_model, "Введите id", Icons.assignment,  FilteringTextInputFormatter.digitsOnly),
                  CustomTextFormField(_model, "Введите имя", Icons.person_rounded,  FilteringTextInputFormatter.deny('/t')),
                  CustomTextFormField(_model, "Введите фамилию", Icons.person_rounded, FilteringTextInputFormatter.deny('/t')),
                  CustomTimeFormField(_model, "Время приёма")
                ]
              )
              ),
              ElevatedButton(
                ...
                onPressed: () {//переход на страницу плеера
              print("Hi");
              },
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: 10),
                child: Text("Далее", style: const TextStyle(
          fontSize: 20.0,
          height: 1,
